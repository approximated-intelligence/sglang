"""
Test script for tool_choice functionality with gRPC Router
Tests: required, auto, and specific function choices in both streaming and non-streaming modes

# To run the tests, use the following command:
#
# python3 -m pytest py_test/e2e/test_grpc_tool_choice.py
"""
...
# Add parent directory to path for importing conftest
sys.path.insert(0, str(Path(__file__).parent))

from conftest import popen_launch_grpc_router
...
class TestGRPCToolChoiceLlama32(CustomTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.process = popen_launch_grpc_router(
            cls.model,
            cls.base_url,
...
class TestToolChoiceQwen25(TestGRPCToolChoiceLlama32):
...
class TestToolChoiceMistral(TestGRPCToolChoiceLlama32):
