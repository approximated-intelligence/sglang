...
class Scheduler(
    ...
    def __init__(
        ...
        # Init metrics stats
        self.init_metrics(server_args, tp_rank, pp_rank, dp_rank, dp_balance_meta)
    ...
    def handle_generate_request(
        ...
        # Update dp balance info
        self.maybe_update_dp_balance_info(recv_req)
