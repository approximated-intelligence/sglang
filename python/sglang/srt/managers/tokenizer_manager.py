...
from sglang.srt.managers.communicator_mixin import CommunicatorMixin
...
class TokenizerManager(CommunicatorMixin):
    ...
    def __init__(
        ...
        # Communicators
        self.init_communicators(self.send_to_scheduler, self.server_args)

        # merge dispatcher with communicators
        self._result_dispatcher = (
            self._result_dispatcher + self._communicator_dispatcher
        )
