...
#   docker build --build-arg SGL_BRANCH=v0.5.3.post3 --build-arg GPU_ARCH=gfx942 -t v0.5.3.post3-rocm630-mi30x -f rocm.Dockerfile .
#   docker build --build-arg SGL_BRANCH=v0.5.3.post3 --build-arg GPU_ARCH=gfx942-rocm700 -t v0.5.3.post3-rocm700-mi30x -f rocm.Dockerfile .
#   docker build --build-arg SGL_BRANCH=v0.5.3.post3 --build-arg GPU_ARCH=gfx950 -t v0.5.3.post3-rocm700-mi35x -f rocm.Dockerfile .
